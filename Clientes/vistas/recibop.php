...
<div class="box-header with-border">
  <h1 class="box-title"> <a href="pendientes.php">  <i class="fa fa-arrow-left"></i> </a>  </h1>
...
<?php
        if(!isset($_GET["id"])){
			...
			$sql = "SELECT p.idpedido, t.idtienda, t.nombre as tienda, t.telefono, t.email,  c.nombre AS cliente, p.fechahora, p.total FROM pedido p INNER JOIN tienda t ON p.idtienda=t.idtienda INNER JOIN cliente c ON c.idcliente=p.idcliente WHERE  p.idpedido='$id' and c.idcliente=".$_SESSION['idcliente']; 
