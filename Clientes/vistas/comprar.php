...
<h1 class="box-title"> <a href="tiendas.php">  <button class="btn btn-warning "><i class="fa fa-chevron-left"></i></button> </a>  </h1> 
<?php
        if(!isset($_GET["id"])){
...
<div class="panel-body" style="height: 400px;" id="formularioros">
  ...
  <div class="form-group col-lg-12 col-md-12 col-xs-12">
     ...
     <input class="form-control" type="" name="fechahora" id="fechahora" required>
   <input class="form-control" type="" name="idtienda" id="idtienda"  value="<?php echo $registro["idtienda"]; ?>">
   <input class="form-control" type="" name="direccion" id="direccion" value="<?php echo $registro["direccion"]; ?>">
...
<br>
  ...
  <center>   <a data-toggle="modal" href="#myModal">
       <button id="btnAgregarArt" type="button" class="btn btn-warning"><span class="fa fa-cutlery "> </span> Nuestro Menú </button></center>
     </a>
    </div>
    ...
    <div class="modal-dialog" style="width: 100% !important;">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Selecciona tus Productos </h4>
        </div>
