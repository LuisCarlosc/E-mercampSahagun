...
public function listarActivosVenta(){
	$sql="SELECT producto.idproducto,producto.nombre as producto, producto.precio, producto.imagen FROM tienda,categoria,producto WHERE tienda.idtienda=categoria.idtienda AND categoria.idcategoria=producto.idcategoria ";
	return ejecutarConsulta($sql);
