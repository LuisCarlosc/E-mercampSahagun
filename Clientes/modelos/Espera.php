...
public function confirmado(){
	...
	$sql="SELECT p.idpedido,p.tipo, t.nombre as tienda, TIMESTAMP(p.fechahora) as fechahora, p.total,p.estadoPago, p.estado FROM pedido p INNER JOIN tienda t ON p.idtienda=t.idtienda INNER JOIN cliente c ON c.idcliente=p.idcliente WHERE p.estado='Confirmado' and c.idcliente='$cliente' 
