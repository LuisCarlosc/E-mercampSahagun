...
public function listarActivosVenta(){
	$sql="SELECT producto.idproducto, producto.nombre as producto, producto.precio, producto.imagen FROM categoria,restaurante,producto WHERE restaurante.idrestaurante=categoria.idrestaurante AND categoria.idcategoria=producto.idcategoria and restaurante.idrestaurante=".$_SESSION['idrestaurante'];
	return ejecutarConsulta($sql);
}
}
 ?>
