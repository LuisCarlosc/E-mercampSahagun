...
public function insertar($nit,$tipo,$nombre,$direccion,$telefono,$imagen){
	$sql="INSERT INTO tienda (Nit,tipo,nombre,direccion,telefono,imagen,condicion)
	 VALUES ('$nit','$tipo','$nombre','$direccion','$telefono','$imagen','1')";
	return ejecutarConsulta($sql);
}

public function editar($idtienda,$nit,$tipo,$nombre,$direccion,$telefono,$imagen){
	$sql="UPDATE tienda SET nit='$nit',tipo='$tipo', nombre='$nombre',direccion='$direccion',telefono='$telefono',imagen='$imagen' 
