...
<?php 
  ...
  $sql="SELECT * from admingen WHERE idadmin=".$_SESSION['idadmin'];
          ...
          <div class="panel panel-success"><br>
            ...
            <div class="panel-body">
              <div class="row">
				...
				<div id="load_img">
					<img class="img-circle" width="200px" height="200px" src='../../files/administrador/<?php echo $row['imagen'];?>' alt="Logo"  height='256px' width='256px'  >
                  ...
                  <table class="table table-condensed">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><input type="text" class="form-control input-sm" name="cedula" autocomplete="off" value="<?php echo $row['cedula']?>" ></td>
                      </tr>
                      ...
                      <tr>
                        <td>Telefono:</td>
                        <td><input type="text" class="form-control input-sm" required name="telefono" autocomplete="off" value="<?php echo $row['telefono']?>"></td>
                      </tr>
