...
function cambiar(idpedido){
	bootbox.confirm("¿Esta seguro de desactivar este dato?", function(result){
		if (result) {
			$.post("../ajax/pedidos.php?op=cambiar", {idpedido : idpedido}, function(e){
				bootbox.alert(e);
				tabla.ajax.reload();
			});
		}
...
function desactivar(idpedido){
	bootbox.confirm("¿Esta seguro de confirmar este pedido?", function(result){
		if (result) {
			$.post("../ajax/pedidos.php?op=desactivar", {idpedido : idpedido}, function(e){
				bootbox.alert(e);
				tabla.ajax.reload();
			});
		}
