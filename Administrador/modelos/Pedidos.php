...
public function desactivar($idpedido){
	$sql="UPDATE pedido INNER JOIN tienda ON tienda.idtienda= pedido.idtienda SET pedido.estado='Confirmado' WHERE pedido.idpedido='$idpedido'  AND tienda.idtienda=".$_SESSION['idtienda'];
	return ejecutarConsulta($sql);
}
...
public function listar(){
	...
	cliente c ON c.idcliente=p.idcliente  WHERE p.estado='En Espera' and 
	t.idtienda='$cliente' 
