...
$idusuario=isset($_POST["iduser"])? limpiarCadena($_POST["iduser"]):"";
...
switch ($_GET["op"]) {
	...
	if (empty($idusuario)) {
		...
		$rspta=$usuario->editar($idusuario,$idtienda,$nombre,$telefono,$cargo,$email,$clavehash,$imagen,$_POST['permisosusers']);
