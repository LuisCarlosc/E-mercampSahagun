	<?php
				...
				}  else
			{
				...
				if ($imageFileZise>0){
                    ...
                    $sql = "UPDATE users SET $logo_update WHERE iduser=".$_SESSION['iduser'];
                    $query_new_insert = mysqli_query($conexion,$sql);

                   
                    if ($query_new_insert) {
                        ?>
						<img class="img-responsive" src="../../files/usuarios/<?php echo $image_name;?>" alt="Imagen" height='156px' width='156px'>
						<?php
                    } else {
